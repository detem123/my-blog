    ...
    <div className="min-h-[80vh] flex items-center justify-center px-5">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800 mt-3">欢迎回来</h1>
          <p className="text-slate-400 text-sm mt-1">登录 InkSpace 继续创作</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm transition"
              placeholder="请输入用户名"
            />
          </div>
          <div>
          ...
          <p className="text-center text-sm text-slate-400">
            还没有账号？
            <Link href="/register" className="text-indigo-600 hover:underline font-medium ml-1">立即注册</Link>
          </p>
        </form>
      </motion.div>
    </div>
